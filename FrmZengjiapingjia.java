...
public class FrmZengjiapingjia extends JDialog implements ActionListener{
	...
	public FrmZengjiapingjia(FrmYonghuMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanYonghu.currentLoginYonghu = Util.yonghuManager.Zengjiapingjia(shangpinbianhao, pingjianeirong, xingji, zhaopian);
