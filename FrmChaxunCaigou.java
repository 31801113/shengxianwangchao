...
public class FrmChaxunCaigou extends JDialog implements ActionListener{
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private JButton btn = new JButton("≤È—Ø");
	private JLabel label1 = new JLabel("≤…π∫µ•±‡∫≈£∫");
	private JLabel label2 = new JLabel(" ≥≤ƒ±‡∫≈£∫");
	private JTextField edt1 = new JTextField(20);
	private JTextField edt2 = new JTextField(20);
	
	public FrmChaxunCaigou(FrmMain f, String s, boolean b) {
		super(f,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ChaxunCaigou(caigoudanbianhao, shicaibianhao);
