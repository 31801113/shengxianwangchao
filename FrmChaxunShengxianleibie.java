...
public class FrmChaxunShengxianleibie extends JDialog implements ActionListener{
	...
	public FrmChaxunShengxianleibie(FrmMain f, String s, boolean b) {
		super(f,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ChaxunShengxianleibie(leibiebianhao, leibiemingcheng);
