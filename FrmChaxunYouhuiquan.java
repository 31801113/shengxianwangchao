...
public class FrmChaxunYouhuiquan extends JDialog implements ActionListener{
	...
	public FrmChaxunYouhuiquan(FrmMain f, String s, boolean b) {
		super(f,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ChaxunYouhuiquan(youhuiquanbianhao);
