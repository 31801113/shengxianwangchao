...
public class FrmBianjiCaipu extends JDialog implements ActionListener{
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private JButton btn = new JButton("¸üÐÂ");
	...
	public FrmBianjiCaipu(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.BainjiCaipu(caipubianhao, caipumingcheng, caipuyongliao, buzhou, tupian);
