...
public class FrmChaxunCaipu extends JDialog implements ActionListener{
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private JButton btn = new JButton("²éÑ¯");
	...
	public FrmChaxunCaipu(FrmMain f, String s, boolean b) {
		super(f,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ChaxunCaipu(caipubianhao, caipumingcheng);
