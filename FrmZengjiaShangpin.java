...
public class FrmZengjiaShangpin extends JDialog implements ActionListener{
	...
	private JLabel label7 = new JLabel("规格：");
	private JLabel label9 = new JLabel("详情：");
	private JLabel label10 = new JLabel("类别编号：");
	...
	public FrmZengjiaShangpin(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			String guige = new String(this.edt7.getText());
			String xiangqing =  new String(this.edt9.getText());
			String leibiebianhao = new String(this.edt10.getText());
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ZengjiaShangpin(shangpinbianhao, shangpinmingcheng, jiage, huiyuanjia, shuliang, guige, xiangqing, leibiebianhao);
