...
public class FrmZengjiaManzhe extends JDialog implements ActionListener{
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private JButton btn = new JButton("增加");
	private JLabel label1 = new JLabel("满折编号：");
	private JLabel label2 = new JLabel("内容：");
	private JLabel label3 = new JLabel("适用商品数量：");
	private JLabel label4 = new JLabel("折扣：");
	...
	public FrmZengjiaManzhe(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			String shiyongshangpinshuliang = new String(this.edt3.getText());
			String zhekou = new String(this.edt4.getText());
			String qishiriqi = new String(this.edt5.getText());
			String jieshuriqi = new String(this.edt6.getText());
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ZengjiaManzhe(manzhebianhao, neirong, shiyongshangpinshuliang, zhekou, qishiriqi, jieshuriqi);
