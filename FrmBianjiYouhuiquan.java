...
public class FrmBianjiYouhuiquan extends JDialog implements ActionListener{
	...
	public FrmBianjiYouhuiquan(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.BianjiYouhuiquan(youhuiquanbianhao, neirong, shiyongjine, jianmianjine, qishiriqi, jieshuriqi);
