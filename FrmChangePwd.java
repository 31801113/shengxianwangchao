...
public class FrmChangePwd extends JDialog implements ActionListener{
	...
	private JLabel label2 = new JLabel("新密码：");
	private JLabel label3 = new JLabel("密码确认：");
	...
	public FrmChangePwd(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String mima = new String(this.edt1.getText());
			String xinmima = new String(this.edt2.getText());
			String mimaqueren = new String(this.edt3.getText());
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.changePwd(BeanGuanliyuan.currentLoginGuanliyuan, mima, xinmima,mimaqueren);
