...
public class FrmBianjiManzhe extends JDialog implements ActionListener{
	...
	public FrmBianjiManzhe(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.BianjiManzhe(manzhebianhao, neirong, shiyongshangpinshuliang, zhekou, qishiriqi, jieshuriqi);
