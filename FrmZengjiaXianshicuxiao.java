...
public class FrmZengjiaXianshicuxiao extends JDialog implements ActionListener{
	...
	public FrmZengjiaXianshicuxiao(FrmMain f, String s, boolean b) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btn)
		{
			...
			try {
				BeanGuanliyuan.currentLoginGuanliyuan = Util.guanliyuanManager.ZengjiaXianshicuxiao(cuxiaobianhao, shangpinbianhao, cuxiaojiage, cuxiaoshuliang, qishiriqi, jieshuriqi);
